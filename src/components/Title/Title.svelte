<script lang="ts">
  ...
  export let secondaryA = '#f975f7';
  export let secondaryB = '#f008b7';

  export let headerSize = 90;
  export let subHeaderSize = 30;

  export let subHeaderMarginTop = -10;
...
<style lang="scss">
  .title {
    ...
    .header-container-container {
      ...
      .header-container {
        ...
        .header {
          ...
          &.header-ends {
            font-size: var(--theme-header-ends-size);
            margin-top: -13px;
          }
        }
      }
    ...
    .subheader {
      ...
      display: flex;
      justify-content: center;
      font-size: var(--theme-subheader-size);
      height: var(--theme-subheader-size);
      color: white;
      z-index: 2;
      color: var(--theme-secondary-a);
      -webkit-text-stroke: 1px var(--theme-secondary-b);
      filter: drop-shadow(2px 2px 20px var(--theme-secondary-b));
      margin-top: var(--theme-subheader-marin-top);
    }
  }
</style>

<div class="title" style={`
  --theme-header-size: ${headerSize}px;
  --theme-header-ends-size: ${headerSize + 30}px;
  --theme-subheader-size: ${subHeaderSize}px;
  --theme-subheader-marin-top: ${subHeaderMarginTop}px;
  --theme-primary-a: ${primaryA};
  --theme-primary-b: ${primaryB};
  --theme-secondary-a: ${secondaryA};
  --theme-secondary-b: ${secondaryB};
  ${style}
`}>
    ...
    <svg>
      <defs>
        ...
        <filter id="outerGlow" >
          ...
          <!-- Change the colour -->
          <feFlood flood-color={primaryA} flood-opacity="0.5" result="glowColor" />
